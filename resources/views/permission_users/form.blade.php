<form>
  <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
    ...
    <div class="mb-4">
        ...
        <select class="bg-gray-200 block w-full  text-gray-500 rounded py-3 px-4 mb-3 leading-tight focus:border-gray-500 focus:bg-white border border-gray-200 " id="userSelected" wire:model="userSelected">
          <option value="null">Selected User</option>
          @foreach ($users as $registry)
          <option value="{{$registry['id']}}">{{$registry['User']}}</option>
          @endforeach
        </select>
